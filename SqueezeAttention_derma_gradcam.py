...
train_data = DermaMNIST(split="train",transform = transforms.ToTensor(),
...
class SqueezeAttentionBlock(nn.Module):
    ...
    def __init__(self,m,n, head = 4):
        ...
        self.depthwise_conv = nn.Conv2d(n, n, 5, padding = "same",groups=n)
...
if __name__ == "__main__":
    pretrained = torch.load("Derma_SqueezeAttention8_1.pt") #Let's get up to 10 epochs?
