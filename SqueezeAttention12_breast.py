...
if __name__ == "__main__":
    for epoch in range(max_epoch):
        ...
        if correct > best:
            ...
            torch.save(net.state_dict(),"Breast_SqueezeAttention54_1.pt")
...
if __name__ == "__main__":
    pretrained = torch.load("Breast_SqueezeAttention54_1.pt") #Let's get up to 10 epochs?
    net.load_state_dict(pretrained)
...
#Version 52: 0.8589743589743589

#Version 53: 0.8846153846153846

#Version 54: 0.8910256410256411