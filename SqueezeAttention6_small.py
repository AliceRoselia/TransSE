...
class SqueezeAttention(nn.Module):
    ...
    def __init__(self,in_channels,classes):
        ...
        self.results = nn.Linear(1024, classes)
    ...
    def forward(self,x):
        ...
        x = self.dropout(x.mean((3,4)).view(-1,1024))
...
if __name__ == "__main__":
    for epoch in range(10):
        ...
        if correct > best:
            ...
            torch.save(net.state_dict(),"Retina_SqueezeAttention_small_1_1.pt")
...
if __name__ == "__main__":
    pretrained = torch.load("Retina_SqueezeAttention_small_1_1.pt") #Let's get up to 10 epochs?
    net.load_state_dict(pretrained)
